                ...
                <div>
                  ...
                  {hoveredIndex === index && (
                    ...
                    >
                      ...
                      >
                        Genres:
                        {animeItem.genres.map((genre, idx) => (
                          <span key={idx}>
                            {genre.name}
                            {idx !== animeItem.genres.length - 1 && ", "}
                          </span>
                        ))}
                      </h1>
                      <div
                      ...
                      >
                        <h1 style={{marginLeft: "5px"}}>MyAnimeList</h1>
                        <button
                          style={{
                            cursor: "pointer",
                          ...
                          onClick={() => {
                            window.open(
                              `https://myanimelist.net/manga/${animeItem.mal_id}`,
                              "_blank"
                            );
                          }}
                        >
                          <TbDirectionSignFilled color="white" size={30} />
                        </button>
                      </div>
                    </div>
                  )}
